...
def parse_train_args(args=sys.argv[1:]):
    ...
    parser.add_argument("--quad_angle_loss", action='store_true', default=False, help='Use the prior\'s angle as truth and make a quadratic loss based on that')
    parser.add_argument("--quad_angle_loss_max", type=float, default=1.0, help='Max value for quadratic angle loss')
