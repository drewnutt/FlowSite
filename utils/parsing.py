...
def parse_train_args(args=sys.argv[1:]):
    ...
    parser.add_argument('--tfn_score', action='store_true', default=False,help='adds a score head to the TFN layers')
    parser.add_argument('--score_hidden_layers', type=int, default=1, help='Number of hidden layers in the score head')
    parser.add_argument('--score_module', default="linear", choices=["linear","transformer"], help='The type of module to use for the score head')
    parser.add_argument('--score_pool', default="cls",choices=["cls","mean"], help='The type of pooling to use for the score head, only used with transformer')
    parser.add_argument('--score_output', default="Conf",choices=["Conf","RMSD"], help='What the score model predicts, a [0,1] confidence value or the RMSD')
...
def parse_confidence_args():
    ...
    parser.add_argument('--run_name', type=str, default='', help='')
    parser.add_argument('--project', type=str, default='harmonicflow_confidence', help='')
    parser.add_argument('--precision', type=str, default='medium', help='high, highest, medium')
    parser.add_argument('--gradient_clip_val', type=float, default=0.0, help='Gradient clipping value')
    parser.add_argument('--num_devices', type=int, default=2, help='Number of GPUs to use')
    parser.add_argument('--print_freq', type=int, default=50, help='')
    ...
    parser.add_argument('--score_model_config', type=FileType(mode='r'), default=None)
    parser.add_argument('--score_model_ckpt', type=str, default='workdir', help='Path to folder with trained model and hyperparameters')
    ...
    parser.add_argument('--num_confidence_outputs', type=int, default=1, help='Number of outputs for the confidence model')
    parser.add_argument('--diffdock_confidence', action='store_true', default=False, help='Whether to use the confidence model from DiffDock')
